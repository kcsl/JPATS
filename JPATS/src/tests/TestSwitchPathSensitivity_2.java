 ...
 * at runtime.
 */
@PathSensitivity(k=1, rationale="Object \"o\" is conditionally overwritten with an instance of type Object2.  In this program the first case statement is never executed.")
@SwitchSensitivity(rationale="The path depends on a switch case statement.")
@PrintedType
public class TestSwitchPathSensitivity_2 implements Test {
